...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+-------+-------+-------+------+------|             |------+------+------+------+------+------|
   * |      | ESC   |  JA   |  EN   | XXXX |      |             |      | C-h  | C-z  | C-m  | M-x  |      |
   * |------+-------+-------+-------+------+------|             |------+------+------+------+------+------|
  ...
  [_SHOTL] = LAYOUT(                                                    \
      ...
      _______, KC_ESC,  JA,      EN,      XXXXXXX, _______,                   _______, C_H,     C_Z,     C_M,     M_X,     _______, \
   ...
   */
  [_SHOTR] = LAYOUT( \
      _______, _______, _______, _______, _______, _______,                   _______, G_S_ENT, _______, _______, _______, _______, \
      _______, _______, _______, _______, _______, _______,                   _______, XXXXXXX, GUI_K,   _______, _______, _______, \

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FINCOL] = LAYOUT_kc( \
  //,------+------+------+------+------+------.               ,------+------+------+------+------+------.
      WBAK ,  D   ,  G   ,  C   , MPLY , VOLU ,                 _sy  ,  UP  ,  B   ,  N   ,  P   ,      ,
  //|------+------+------+------+------+------|               |------+------+------+------+------+------|
       Q   ,  I   ,  U   ,  E   , _ex  , VOLD ,                 RGHT ,  ENT ,  M   ,  S   ,  T   ,  F   ,
  //|------+------+------+------+------+------|               |------+------+------+------+------+------|
      A_sf ,  X   ,  W   ,  Y   , MNXT ,      ,                 LEFT , DOWN ,  H   ,  J   ,  K   , R_sf ,
  //|------+------+------+------+------+------+------' `------+------+------+------+------+------+------'
       V   , WBAK ,      , ESC  , LAal , O_ct ,  EN  ,    JA  , SPsy , Z_ss , BSPC ,      ,      ,  L
  //`------+------+------+------+------+------+------' `------+------+------+------+------+------+------'
  ),

  [_SYMBOL] = LAYOUT_kc( \
  //,------+------+------+------+------+------.               ,------+------+------+------+------+------.
           ,  7   ,  8   ,  9   ,      ,      ,                 _sy  ,      , DQUO , LBRC , RBRC ,      ,
  //|------+------+------+------+------+------|               |------+------+------+------+------+------|
      BSLS ,  4   ,  5   ,  6   ,      ,      ,                      ,      , MINS , COMM , DOT  ,      ,
  //|------+------+------+------+------+------|               |------+------+------+------+------+------|
       0   ,  1   ,  2   ,  3   ,      ,      ,                      ,      , EQL  , SCLN , COLN , SLSH ,
  //|------+------+------+------+------+------+------' `------+------+------+------+------+------+------'
      TILD ,      ,      ,      ,      ,      ,      ,        ,      ,      ,      ,      ,      ,
  //`------+------+------+------+------+------+------' `------+------+------+------+------+------+------'
  ),
  ...
  [_S_SYMB] = LAYOUT_kc( \
  //,------+------+------+------+------+------.               ,------+------+------+------+------+------.
           , AMPR , ASTR , RPRN ,      ,      ,                 RSET ,      , QUOT , LCBR , RCBR ,      ,
  //|------+------+------+------+------+------|               |------+------+------+------+------+------|
      PIPE , DLR  , PERC , CIRC ,      ,      ,                      ,      , UNDS ,  LT  ,  GT  ,      ,
  //|------+------+------+------+------+------|               |------+------+------+------+------+------|
      LPRN , EXLM ,  AT  , HASH ,      ,      ,                      ,      , PLUS , sf_l , sf_r , QUES ,
  //|------+------+------+------+------+------+------' `------+------+------+------+------+------+------'
      GRV  ,      ,      ,      ,      ,      ,      ,        ,      ,      ,      ,      ,      ,
  //`------+------+------+------+------+------+------' `------+------+------+------+------+------+------'
  ),

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYMBOL] = LAYOUT( \
      ...
      _______, _______,  KC_4,    KC_5,    KC_6,    _______,                   _______, KC_MINS, KC_COMM, KC_DOT,  KC_BSLS,  _______, \
      _______, ZERO_SFT, KC_1,    KC_2,    KC_3,    _______,                   _______, KC_F12,  KC_GRV, KC_QUOT , SLSH_SFT, SYMB_T,  \
      _______, KC_SCLN,  _______, _______, C_V,     F12_CTL, _______, _______, _______, _______, _______, _______, KC_SCLN,  _______  \
      ),

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* FinCol:
   * ,-----------------------------------.           ,-----------------------------------.
   * | Vo+ | Tb  |  G  |  D  |  Y  |  Up |           |  ,  |  B o|  N f|  P  | BS  | Adj |
   * |-----+-----+-----+-----+-----+-----|           |-----+-----+-----+-----+-----+-----|
   * | Vo- |  V  |  I  |  U  |  E  | Down|           |  .  |  M  |  S s|  R  |  F  |Play |
   * |-----+-----+-----+-----+-----+-----|           |-----+-----+-----+-----+-----+-----|
   * | +Ex |A /SF|  Z  |  W  |  C  | --- |           | --- |  H  |  J  |  K c|T/SF | +SY |
   * |-----+-----+-----+-----+-----+-----+-----------+-----+-----+-----+-----+-----+-----|
   * | Sp  |  X  | Prv | Nxt |Q /EX|O /CT|En/GU|Tb/AL|Sp/SY|Es/EX| Let |Right|  L  | Ent |
   * `-----------------------------------------------------------------------------------'
   */
  [_FINCOL] = LAYOUT( \
      ...
      KC_SPC,  KC_X,    KC_LEFT, KC_RGHT, Q_EX,    O_LCTL,  EN_GUI, TB_ALT, SP_STAR, ESC_EX,  KC_LEFT, KC_RGHT, KC_L,     KC_ENT   \
      ),
   ...
   * |     |     |     |     |     |     |           |     |WH L |WH D |WH U |     |     |
   * |-----+-----+-----+-----+-----+-----|           |-----+-----+-----+-----+-----+-----|
   * |     |     |GLPS |GU-+ |GU-- |     |           |     |MS L |MS D |MS U |WH R |     |
   * |-----+-----+-----+-----+-----+-----|           |-----+-----+-----+-----+-----+-----|
   * | -EX |     |     |     |     |     |           |     |Left |Down | Up  |MS R |     |
   * |-----+-----+-----+-----+-----+-----+-----------+-----+-----+-----+-----+-----+-----|
   * |     |     |     |     |     |     |     |B2/Al| B1  |     |     |     |Right|     |
   * `-----------------------------------------------------------------------------------'
   */
  [_EXTRA] = LAYOUT( \
      ...
      EX_T,    _______, _______, _______, _______, _______,                   _______, KC_LEFT, KC_DOWN, KC_UP,   KC_MS_R, _______, \
